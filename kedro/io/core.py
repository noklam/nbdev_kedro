# AUTOGENERATED! DO NOT EDIT! File to edit: ../01_io_core.ipynb.

# %% auto 0
__all__ = ['VERSION_FORMAT', 'VERSIONED_FLAG_KEY', 'VERSION_KEY', 'HTTP_PROTOCOLS', 'PROTOCOL_DELIMITER', 'CLOUD_PROTOCOLS',
           'DataSetError', 'DataSetNotFoundError', 'DataSetAlreadyExistsError', 'VersionNotFoundError',
           'AbstractDataSet', 'generate_timestamp', 'Version', 'parse_dataset_definition', 'AbstractVersionedDataSet',
