# AUTOGENERATED! DO NOT EDIT! File to edit: ../04_extras_datasets_pandas_csv_dataset.ipynb.

# %% auto 0
__all__ = ['logger', 'CSVDataSet']

# %% ../04_extras_datasets_pandas_csv_dataset.ipynb 2
